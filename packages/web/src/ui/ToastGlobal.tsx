...
const ToastGlobalProvider = () => {
  ...
  useEffect(() => {
    // if (typeof globalToast === 'function') throw new Error('Only one Toast.Global can be initialized');
...
export default memo(ToastGlobalProvider);
